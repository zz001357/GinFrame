...
COPY --from=0 /GinFrame/BlogServer/app /BlogServer/
COPY --from=0 /GinFrame/BlogServer/config_blog.yaml /BlogServer/
EXPOSE 8005
# 运行golang程序的命令
ENTRYPOINT ./BlogServer/app
