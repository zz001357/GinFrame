...
func (s *Server) GetResumeInfo1(ctx context.Context, in *pb.ResumeInfoRequest) (*pb.ResumeInfoReply, error) {
	/**
	 * @Name 获取简历信息
	 * @Param	search_key	string	模糊搜索关键字
	 * @Return
...
func (s *Server) GetResumeInfo2(ctx context.Context, in *pb.ResumeInfoRequest) (*pb.ResumeInfoReply, error) {
	/**
	 * @Name 获取简历信息
	 * @Param	search_key	string	模糊搜索关键字
	 * @Return
